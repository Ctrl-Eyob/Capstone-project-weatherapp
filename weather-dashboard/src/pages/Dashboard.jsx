      ...
      <main className="flex-1 p-6 md:ml-64">
        ...
        {weather && !loading && (
          <>
            ...
            <div className="mt-6 bg-white/60 dark:bg-slate-800/70 backdrop-blur-lg rounded-2xl p-6 shadow">
              ...
              <p className="capitalize mt-2 text-slate-700 dark:text-slate-300">
